...
export class HeroComponent {
  emailURL: string =
    "mailto:safwatahmed669@gmail.com?subject=General Inquiry about [Your Question]&body= Hello, Safwat Ahmed%0D%0A%0D%0AI'm [Your Name] from [Your Company].%0D%0A%0D%0A I'm reaching you for ...";
